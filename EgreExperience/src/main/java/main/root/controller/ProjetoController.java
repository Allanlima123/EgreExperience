...
public class ProjetoController {
	...
	@PutMapping("/{id}")
	public ResponseEntity<Projeto> atualizarProjeto(@PathVariable int id, @RequestBody ProjetoDto projetoDto) {
		try {
			Projeto projeto = projetoService.atualizarProjeto(id, projetoDto);
